# Claude code GUI
### Foreword
Hi, I am mike, a 13 years old boy in secondary school,I like vibe coding. Last year,I heard of vibe coding, It make me surprised and I start to use cursor. Last month, I saw something called “Claude code”,I purchesed and tried. It made me more surprised that it is better than cursor except….. Claude code runs in the terminal,I try to find some projects on github, I found claudia and claudecodeui, but to be a GUI, their designing are not as good as claude web ,or cursor. They just turn the output into blocks, which made it still complecated, so I decided to create one myself, make it easy and pretty, for myself and you.
### Technology stack
